...
const Products = ({product }) => {
  ...
  return (
 <Link to={`/FakeStore/details/${product.id}`}  className=' min-h-[100px]  sm:max-h-[230px]  bg-white inline-block p-4 sm:p-4  border-1 overflow-hidden border-gray-100 shadow-md shadow-gray-400'>
